...
// ---------------------------------------------------------------------------
// Ticket ids — the canonical commit/branch grammar (now the layer-neutral
// `contracts/ticket-id.ts` module; re-exported here so the many source consumers
// that `import … from "./parse.js"` keep working unchanged — COS-5c cohesion fold).
// ---------------------------------------------------------------------------

export { extractTicketIds, prefixOf, ticketFromFilename } from "../contracts/ticket-id.js";
