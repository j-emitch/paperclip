...
import { NOW, branchSignal, bundleOf, docSignal, repoGitSignal, taxon, work } from "../fixtures/signals.js";

/**
 * The COS-0 regression guard: the three new signal kinds (branch / repo_git /
 * doc) must be IGNORED by the existing folds (filter-in, no exhaustive switch), so
